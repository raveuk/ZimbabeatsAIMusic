...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Myuzika`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Myuzika.`;
...
const resetMetaTags = () => {
    ...
    updateMeta('meta[property="og:title"]', 'Myuzika - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Myuzika - Local AI Music Generator');
