...
import { Library, Disc, Search, LogIn, LogOut, Sun, Moon, GraduationCap, Newspaper, Film } from 'lucide-react';
    ...
    <>
      ...
      <nav className="flex-1 flex flex-col gap-2 w-full px-3">
        ...
        <NavItem
          icon={<Film size={20} />}
          label="AI Video"
          active={currentView === 'musicvideo'}
          onClick={() => onNavigate('musicvideo')}
          isExpanded={isOpen}
        />
        <NavItem
