...
export const translations = {
  en: {
    ...
    poweredBy: 'Built with state-of-the-art AI music generation.',
    createdBy: 'Created by Zimbabeats.com',
  ...
  zh: {
    ...
    poweredBy: '由最先进的 AI 音乐生成技术驱动。',
    createdBy: '由 Zimbabeats.com 制作',
  ...
  ja: {
    ...
    poweredBy: '最先端のAI音楽生成技術を搭載。',
    createdBy: 'Zimbabeats.com 制作',
  ...
  ko: {
    ...
    poweredBy: '최첨단 AI 음악 생성 기반.',
    createdBy: 'Zimbabeats.com 제작',
